...
export NORMAL_FONT_SIZE=20
export ZOOMED_FONT_SIZE=$(( NORMAL_FONT_SIZE * 2 ))

export CTESP="$HOME/Documents/CTeSP"
export BOOKS="$HOME/Library/Mobile Documents/iCloud~com~apple~iBooks/Documents"

export PATH="$HOME/bin:$HOME/.local/bin:$HOME/.gem/ruby/3.4.0/bin:$HOME/.config/scripts:$PATH"
